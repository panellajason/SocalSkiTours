...
class SanJacintoTours {
    ...
    static func loadTours(completion:@escaping (_ tours:[Tour])->()) {
        ...
        sanJacintoTH.icon = GMSMarker.markerImage(with: .brown)
        ...
        snowCreekTH.icon = GMSMarker.markerImage(with: .brown)
