...
class BigBearTours {
    ...
    static func loadTours(completion:@escaping (_ tours:[Tour])->()) {
        ...
        let jepsonNW = Tour(path: sfPath, id: "34.103435 -116.847386", imageURL: [#imageLiteral(resourceName: "jepson_nw"), #imageLiteral(resourceName: "IMG_4364"), #imageLiteral(resourceName: "IMG_0673"), #imageLiteral(resourceName: "DDF34D9F-6ABB-4F2A-A1CE-3BB8D4CB6A4C"), #imageLiteral(resourceName: "IMG_1214"), #imageLiteral(resourceName: "IMG_1185")], distance: "6 miles", description: "Three defined, north facing chutes with many others that come to life on good snow years. Cornices are common on many of the entrances to these chutes in winter and wind-affect is as well. These chutes are typically rideable well into spring if we've had a decent snow year, sometimes early summer. The looker's right chutes are more complex and tighter while the three main chutes are very open and straightforward. Follow the South Fork Trail for 3.5 miles, then cross the South Fork meadows and continue up through the trees. The terrain will become a series of small gullies but head in the SW direction and follow the gullies up and around Charlton Peak until the trees begin to clear. Continue up the opening until you reach the saddle between Jepson and Little Charlton Peak; boot or skin up this and follow Jepson's ridge up to the summit.", title: "Jepson Peak: N Chutes", aspect: "N", base: "6,900 ft", trailhead: "South Fork Trailhead", summit: "11,200 ft", angle: "35-40")
        
        let nePath = sfPath.mutableCopy()
        (nePath as AnyObject).add(CLLocationCoordinate2D(latitude: 34.101618, longitude: -116.843024))
        let jepsonNE = Tour(path: nePath as! GMSMutablePath, id: "34.101618 -116.843024", imageURL: [#imageLiteral(resourceName: "jepson_ne"), #imageLiteral(resourceName: "IMG_1402"), #imageLiteral(resourceName: "IMG_0794"), #imageLiteral(resourceName: "IMG_0875"), #imageLiteral(resourceName: "IMG_1216")], distance: "6.5 miles", description: "Similar to its N chutes, except these are slightly steeper and more technical. In good corn cycles, these chutes and the N chutes are a great link-up since these will soften first due to their easterly exposure to the sun. Cornices form at the entrances to some of these chutes and wind-affected snow is common, but there are some golden days when conditions are soft powder and stable in late winter/early spring. Follow either the Big Draw route or the Jepson N chutes route; I prefer the Jepson N chutes routes as it is slightly shorter.", title: "Jepson Peak: NE Chutes", aspect: "NE", base: "6,900 ft", trailhead: "South Fork Trailhead", summit: "11,200 ft", angle: "35-40")
        ...
        let bigdraw = Tour(path: gorgPath, id: "34.099683 -116.838692", imageURL: [#imageLiteral(resourceName: "big_draw"), #imageLiteral(resourceName: "IMG_0913"), #imageLiteral(resourceName: "IMG_0058"), #imageLiteral(resourceName: "IMG_0878")], distance: "6.5 miles", description: "One of the most classic descents in Southern California, the Big Draw has been skied since the early 1900s (San Gorgonio Ski Club) and was petitioned to become a ski resort in the 1940s but failed. Today, it is known as a rite of passage in Socal backcountry skiing and offers the easiest way up the San G/Jepson saddle. The Big Draw is the ultimate catchers mitt for snow and is usually the last remaining snow in southern California, sometimes having patches last till July after good snow years. In 2019, this skiable for several thousand feet well into June. Follow the South Fork Trail for 3.5 miles, then cross the South Fork meadows and continue up through the trees. The terrain will become a series of small gullies but head in the SE direction and the terrain will flatten out, the trees will clear, and the Big Draw bowl will be the saddle between San G's NW chutes and Jepson's NE chutes. If conditions allow, skinning up the entirety of this bowl without switching to bootpacking is manageable.", title: "San Gorgonio: The Big Draw", aspect: "N", base: "6,900 ft", trailhead: "South Fork Trailhead", summit: "11,200 ft", angle: "30-35")
        ...
        let gorgN = Tour(path: nPath as! GMSMutablePath, id: "34.101979 -116.830673", imageURL: [#imageLiteral(resourceName: "IMG_1436"), #imageLiteral(resourceName: "gorg_n"), #imageLiteral(resourceName: "IMG_9002"), #imageLiteral(resourceName: "gorg1")], distance: "6.5 miles", description: "The tallest mountain in SoCal at 11,500 ft and a moderate 2,000 ft descent down broad chutes. It seems every few years during/after a big storm the North face of San G has massive avalanches (See the 4th pic of the Valentines Day slides from 2019 courtesy of Socalsnow.org, these occurred after a large atmopsheric river and high snow levels.) so be aware of conditions before heading up. If skiing conditions are favorable, these chutes feel like a black diamond ski resort run despite the mountain looking like a giant from afar. The upper few hundred feet of the chutes are usually wind-stripped or wind-affected. This area was under threat of development in the mid 1900s, but the ultimate decision was that “San Gorgonio Primitive Area has a higher public value as a wilderness and a watershed than as a downhill ski area”. Follow the Big Draw route or branch off and climb the North chutes directly for a slightly steeper but more direct route.", title: "San Gorgonio: North Slope", aspect: "N", base: "6,900 ft", trailhead: "South Fork Trailhead", summit: "11,400 ft", angle: "30-35")
