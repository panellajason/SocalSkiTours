...
class SanGabrielsTours {
    ...
    static func loadTours(completion:@escaping (_ tours:[Tour])->()) {
        ...
        let krakta = Tour(path: kraktaPath, id: "34.347518 -117.897992", imageURL: [#imageLiteral(resourceName: "krakta"), #imageLiteral(resourceName: "krakta2")], distance: "1 mile", description: "Krakta Ridge Ski Area, aka Snowcrest, is currently an abandoned ski resort which was open from 1954-2001. Avalanches, fires, and lawsuits were the demise of the resort in 2001. The ski area has since been sold and remained abandoned for roughly 20 years despite being bought by the same owners as Mount Waterman Ski Lifts. The terrain is short and steep which is comprised of overgrown ski runs, areas of well-spaced trees, and some areas of tight, new-growth trees. Krakta is perfect for a couple of short, quick laps due to its ease of access and lack of approach, but beware of road conditions as the CA 2  is not one of the top priority highways to plow after a heavy winter storm like some of the others in Southern California. At such a low elevation and being so close to the ocean, snow quality is usually lacking in the western San Gabriels but spring can be quite fun and turns are turns, afterall.", title: "Krakta Ridge: Ski Area", aspect: "N", base: "6,800 ft", trailhead: "Krakta Ridge Parking", summit: "7,500 ft", angle: "20-30")
        ...
        let waterman = Tour(path: watermanPath, id: "34.345932 -117.933253", imageURL: [#imageLiteral(resourceName: "waterman"), #imageLiteral(resourceName: "waterman2")], distance: "1 mile", description: "Although still operating, Mount Waterman Ski Lifts is open at such an inconsistent rate (usually weekends, if at all) it may as well be considered a backcountry destination. Boasting the first chairlift in Southern California and second in the state, Waterman is a gem in Socal's ski history which opened in 1939. The website is active and lift-accessed skiing still does happen here, so don't be suprised if the resort is open when you arrive; just drive down the road and ski something else (Krakta Ridge, Buckhorn, Throop, Islip). The joys of Waterman are its steep ski runs, tight gullies, and decent tree spacing. There are plently of other options just off of the resort area as well. Some of which that are much more committing and dangerous than the normal Waterman day, such as the Avalanche Chutes off of the summit which drop you a few miles down the road from the parking area. Highway 2 can be quite fickle with opening after a storm so keep an eye on Caltrans before making the drive; this is not a top priority highway compared to others in Socal. The western San Gabriels are lower elevation and very close to the ocean so San Gabriel Cement/Stucco (similar to Sierra Cement but worse) is common.", title: "Mount Waterman: Ski Area", aspect: "N", base: "6,800 ft", trailhead: "Waterman Parking", summit: "7,800 ft", angle: "25-30")
