...
class SanBernardinoTours {
    ...
    static func loadTours(completion:@escaping (_ tours:[Tour])->()) {
        ...
        let jepsonNW = Tour(title: "Jepson Peak: North Chutes", path: jepNWLine, id: "34.103435 -116.847386", imageURL: [#imageLiteral(resourceName: "jepson_nw"), #imageLiteral(resourceName: "IMG_4364"), #imageLiteral(resourceName: "IMG_0673"), #imageLiteral(resourceName: "DDF34D9F-6ABB-4F2A-A1CE-3BB8D4CB6A4C"), #imageLiteral(resourceName: "IMG_1214"), #imageLiteral(resourceName: "IMG_1185")], distance: "6 miles", description: "Three defined, north facing chutes with many others that come to life on good snow years. The looker's right chutes are more complex and technical while the three main chutes are very open and straightforward. This is the alpine so avalanches and cornices are common and wind-affected snow is as well. These chutes are typically rideable well into spring if there has been a decent snow year, sometimes even early summer. Follow the South Fork Trail for 3.5 miles, then cross the South Fork meadows and continue south. The terrain will become a series of treed gullies but head in the SW direction and follow the gullies up and around Charlton Peak until the trees begin to clear. Continue up this old avalanche path until you are able to see the obvious saddle between Jepson Peak and Little Charlton Peak; boot or skin up this and follow Jepson's ridge up to the summit.", marker: jepsonNWMarker, aspect: "N", base: "6,900 ft", trailhead: southForkTH, summit: "11,200 ft", angle: "35-40")
        ...
        let jepsonNE = Tour(title: "Jepson Peak: NE Chutes", path: jepNELine, id: "34.101618 -116.843024", imageURL: [#imageLiteral(resourceName: "jepson_ne"), #imageLiteral(resourceName: "IMG_1402"), #imageLiteral(resourceName: "IMG_0794"), #imageLiteral(resourceName: "IMG_0875"), #imageLiteral(resourceName: "IMG_1216")], distance: "6.5 miles", description: "Jepson's northeast cirque is one of the most beautiful set of lines in this region. Similar to the N chutes, except these are slightly steeper and more technical. An especially fun line is down Jepson's spine which offers a number of chutes to choose from on the way down. In good corn cycles, these chutes and the N chutes are a great link-up since these will soften first due to their easterly exposure to the sun. This exposure also allows the snow to heat up fairly quickly and wet slides are common throughout the season. Cornices form at the entrances to some of these chutes and wind-affected snow is common. In spite of that, there are some golden days when conditions are soft and stable in late winter/early spring. Follow either the Big Draw route or the Jepson N chutes route; I prefer the Jepson N chutes routes as it is slightly shorter.", marker: jepsonNEMarker, aspect: "NE", base: "6,900 ft", trailhead: southForkTH, summit: "11,200 ft", angle: "38-40")
