...
class SanBernardinoTours {
    ...
    static func loadTours(completion:@escaping (_ tours:[Tour])->()) {
        ...
        let sugarloaf = Tour(title: "Sugarloaf: Rock Bowl", difficulty: 1, path: sugLine, id: "34.204253 -116.796951", imageURL: [#imageLiteral(resourceName: "sug2"), #imageLiteral(resourceName: "sug"), #imageLiteral(resourceName: "sug3"), #imageLiteral(resourceName: "sug4")], distance: 4, description: "A relatively low-angle mountain which offers sheltered trees, long gullies, and a few open bowls. This mountain is rather large and spread out (with the summit being a medium to full day of hiking) but there are plenty of shorter options that are worth-while if you are creative. The snow quality is usually decent up high and since much of the mountain is north facing trees, it holds soft snow quite well during winter months if the nights are cold and clear. Spring can also be fun in corn cycles. Follow forest road 2N23 for a mile or so and branch off the road for your desired tour. It's nice to have a GPS map with topography view to navigate this mountain as it's almost all trees which makes it hard to get a good read on location/orientation.", marker: sugarloafMarker, aspect: "NE", base: "7,000 ft", trailhead: sugarTH, summit: "9,400 ft", angle: "25-30")
