...
class SanBernardinoTours {
    ...
    static func loadTours(completion:@escaping (_ tours:[Tour])->()) {
        ...
        let jepsonNW = Tour(title: "Jepson Peak: North Chutes", difficulty: 3, path: jepNWLine, id: "34.103435 -116.847386", imageURL: [#imageLiteral(resourceName: "jepson_nw"), #imageLiteral(resourceName: "IMG_4364"), #imageLiteral(resourceName: "IMG_0673"), #imageLiteral(resourceName: "DDF34D9F-6ABB-4F2A-A1CE-3BB8D4CB6A4C"), #imageLiteral(resourceName: "IMG_1214"), #imageLiteral(resourceName: "IMG_1185")], distance: 6, description: "Three defined, north facing chutes with many others that fill in during good snow years. The looker's right chutes are a bit more interesting than the three main chutes which are very open and straightforward. The entrances may be guarded with cornices and wind-affected snow is common during much of the winter as well. These chutes are typically rideable well into spring if there has been a decent snow year, sometimes even early June. Follow the South Fork Trail for 3.5 miles, then cross the South Fork meadows and continue south. The terrain will become a series of treed gullies but head in the SW direction and follow the gullies up and around Charlton Peak until the trees begin to clear. Continue up this old avalanche path until you are able to see the obvious saddle between Jepson Peak and Little Charlton Peak; boot or skin up this and follow Jepson's ridge up to the summit chutes (or just climb the chutes directly).", marker: jepsonNWMarker, aspect: "N", base: "6,900 ft", trailhead: southForkTH, summit: "11,200 ft", angle: "35-40")
        ...
        let jepsonNE = Tour(title: "Jepson Peak: NE Chutes", difficulty: 3, path: jepNELine, id: "34.101618 -116.843024", imageURL: [#imageLiteral(resourceName: "jepson_ne"), #imageLiteral(resourceName: "IMG_1402"), #imageLiteral(resourceName: "IMG_0794"), #imageLiteral(resourceName: "IMG_0875"), #imageLiteral(resourceName: "IMG_1216")], distance: 6.5, description: "Jepson's northeast cirque is one of the most beautiful set of lines in the region. Similar to the Jepson's North chutes, except these are slightly steeper and there is a little bit more to choose from. An especially fun line is following Jepson's spine which offers a number of chutes to choose from on the way down. In good corn cycles, these chutes and the North chutes are a great link-up since these will soften first due to their easterly exposure. This exposure also allows the snow to heat up fairly quickly and wet slides are common throughout the season. Cornices form at the entrances to some of these chutes and wind-affected snow is common. In spite of that, there are some golden days when conditions are soft and stable in late winter/early spring. Follow the South Fork Trail for 3.5 miles, then cross South Fork meadows and continue up through the trees. The terrain will become a series of small gullies but head in the SE direction and the terrain will eventually flatten out, the trees will clear, and the large bowl known as the Big Draw will become visible; climb or skin to the top. Follow the Jepson ridge to your desired chute. Alternatively, climb the chutes directly.", marker: jepsonNEMarker, aspect: "NE", base: "6,900 ft", trailhead: southForkTH, summit: "11,200 ft", angle: "38-40")
        ...
        let bigdraw = Tour(title: "San Gorgonio: The Big Draw", difficulty: 3, path: gorgLine, id: "34.099683 -116.838692", imageURL: [#imageLiteral(resourceName: "big_draw"), #imageLiteral(resourceName: "IMG_0913"), #imageLiteral(resourceName: "IMG_0058"), #imageLiteral(resourceName: "IMG_0878")], distance: 6.5, description: "One of the most classic descents in Southern California. The Big Draw has been skied by the San Gorgonio Ski Club and many others since the early 1900s. The area was petitioned to become a ski resort in the 1940s but failed. Today, it is known as a rite of passage in SoCal backcountry skiing and also offers the easiest way up the San Gorgonio/Jepson saddle. The Big Draw is an excellent catcher's mitt for snow as it is essentially a large bowl positioned between two windstrewn peaks. It is usually the last remaining snow in Southern California, sometimes having patches last into July. In 2017, 2019, and other good years, this will be skiable for several thousand feet well into June. This last winter season (2021), however, much of this area was hardly skiable or never became skiable due to lack of snow. Follow the South Fork Trail for 3.5 miles, then cross South Fork meadows and continue up through the trees. The terrain will become a series of small gullies but head in the SE direction and the terrain will flatten out, the trees will clear, and the large bowl known as the Big Draw will become visible; climb or skin to the top.", marker: bigDrawMarker, aspect: "N", base: "6,900 ft", trailhead: southForkTH, summit: "11,200 ft", angle: "30-35")
        ...
        let charMain = Tour(title: "Charlton Peak: Main Gully", difficulty: 2, path: charMLine, id: "34.116171 -116.853881", imageURL: [#imageLiteral(resourceName: "main0"), #imageLiteral(resourceName: "mainchar"),  #imageLiteral(resourceName: "main3"), #imageLiteral(resourceName: "main2"), #imageLiteral(resourceName: "main5")], distance: 5.5, description: "The main attraction on Charlton Peak and a 2,000+ ft descent down a north facing gully. Charlton is a big mountain at 10,800+ feet and with a 5+ mile approach it can be quite a slog in deep powder. While Big Bear resorts may only receive 3-4 inches during a storm, it's possible for the summits in this area to receive a foot; this can either be a blessing or more than one bargained for on a bigger storm. Being a high elevation mountain with abundant tree protection, the north side of Charlton can potentially hold soft snow for weeks if there are continued cold, clear nights after a decent storm. The 'walls' on either side of the chute are quite steep and are prone to slide with a good dump (as are all the chutes on this mountain). Follow the South Fork Trail for about 3.5 miles, then cross the South Fork meadows and make your way up the low-angle, eastern ridge of Charlton as the route shows on the map. The entrance to the chute is within 400 feet from the summit and is visible next to a pile of rocks in the northerly direction.", marker: charMainMarker, aspect: "N", base: "6,900 ft", trailhead: southForkTH, summit: "10,800 ft", angle: "30-35")
        ...
        let altoDiablo = Tour(title: "Alto Diablo: Avy Path", difficulty: 2, path: altoLine, id: "34.131813 -116.866294", imageURL: [#imageLiteral(resourceName: "alt2"), #imageLiteral(resourceName: "alt1"), #imageLiteral(resourceName: "alt4")], distance: 4, description: "This avalanche path is one of the closer descents along the South Fork trail and offers two moderate, open pitches. The upper pitch has some short, steep chutes that are great for doing multiple laps and practicing for more committing terrain in the area. There is another bowl which is just behind the upper pitch and has very similar terrain, as can be seen in the 3rd picture. Despite looking like a tame descent, keep in mind there aren't any trees in this area for a reason; avalanches from the upper pitch cleared them out. Follow the South Fork Trail for about 2 miles until the lower pitch (a large clearing of trees) comes into view, then follow the lower and upper pitch up to the summit. Alternatively, approach via the North Trees route.", marker: altoMarker, aspect: "NE", base: "6,900 ft", trailhead: southForkTH, summit: "10,200 ft", angle: "30-35")
