...
class SanBernardinoTours {
    ...
    static func loadTours(completion:@escaping (_ tours:[Tour])->()) {
        ...
        let jepsonNW = Tour(title: "Jepson Peak: North Chutes", path: jepNWLine, id: "34.103435 -116.847386", imageURL: [#imageLiteral(resourceName: "jepson_nw"), #imageLiteral(resourceName: "IMG_4364"), #imageLiteral(resourceName: "IMG_0673"), #imageLiteral(resourceName: "DDF34D9F-6ABB-4F2A-A1CE-3BB8D4CB6A4C"), #imageLiteral(resourceName: "IMG_1214"), #imageLiteral(resourceName: "IMG_1185")], distance: "6 miles", description: "Three defined, north facing chutes with many others that come to life on good snow years. The looker's right chutes are more complex and tighter while the three main chutes are very open and straightforward. This is the alpine so cornices are common on many of the entrances to these chutes and wind-affect is as well. These chutes are typically rideable well into spring if there has been a decent snow year, sometimes even early summer.  Follow the South Fork Trail for 3.5 miles, then cross the South Fork meadows and continue up through the trees. The terrain will become a series of small gullies but head in the SW direction and follow the gullies up and around Charlton Peak until the trees begin to clear. Continue up this old avalanche path until you are able to see the obvious saddle between Jepson and Little Charlton Peak; boot or skin up this and follow Jepson's ridge up to the summit.", marker: jepsonNWMarker, aspect: "N", base: "6,900 ft", trailhead: southForkTH, summit: "11,200 ft", angle: "35-40")
        ...
        let jepsonNE = Tour(title: "Jepson Peak: NE Chutes", path: jepNELine, id: "34.101618 -116.843024", imageURL: [#imageLiteral(resourceName: "jepson_ne"), #imageLiteral(resourceName: "IMG_1402"), #imageLiteral(resourceName: "IMG_0794"), #imageLiteral(resourceName: "IMG_0875"), #imageLiteral(resourceName: "IMG_1216")], distance: "6.5 miles", description: "Similar to the N chutes, except these are slightly steeper and more technical. In good corn cycles, these chutes and the N chutes are a great link-up with each other since these will soften first due to their easterly exposure to the sun. This exposure also allows the snow to heat up fairly quickly and wet slides are common throughout the season. Cornices form at the entrances to some of these chutes and wind-affected snow is common, but there are some golden days when conditions are soft powder and stable in late winter/early spring. Follow either the Big Draw route or the Jepson N chutes route; I prefer the Jepson N chutes routes as it is slightly shorter.", marker: jepsonNEMarker, aspect: "NE", base: "6,900 ft", trailhead: southForkTH, summit: "11,200 ft", angle: "35-40")
        ...
        let bigdraw = Tour(title: "San Gorgonio: The Big Draw", path: gorgLine, id: "34.099683 -116.838692", imageURL: [#imageLiteral(resourceName: "big_draw"), #imageLiteral(resourceName: "IMG_0913"), #imageLiteral(resourceName: "IMG_0058"), #imageLiteral(resourceName: "IMG_0878")], distance: "6.5 miles", description: "One of the most classic descents in Southern California, the Big Draw has been skied since the early 1900s by the San Gorgonio Ski Club. The area was petitioned to become a ski resort in the 1940s but failed. Today, it is known as a rite of passage in SoCal backcountry skiing and also offers the easiest way up the San G/Jepson saddle. The Big Draw is an excellent catcher's mitt for snow as it is essentially a large bowl positioned between two windstrewn peaks. It is usually the last remaining snow in Southern California, sometimes having patches last into July. In 2019, this was skiable for several thousand feet well into June. This last winter season (2021), however, much of the area was hardly rideable or never became rideable due to lack of snow. Follow the South Fork Trail for 3.5 miles, then cross the South Fork meadows and continue up through the trees. The terrain will become a series of small gullies but head in the SE direction and the terrain will flatten out, the trees will clear, and the large bowl known as the Big Draw will become visible. If conditions allow, skinning up the entirety of this bowl, without switching to bootpacking, is manageable.", marker: bigDrawMarker, aspect: "N", base: "6,900 ft", trailhead: southForkTH, summit: "11,200 ft", angle: "30-35")
        ...
        let charMain = Tour(title: "Charlton Peak: Main Gully", path: charMLine, id: "34.116171 -116.853881", imageURL: [#imageLiteral(resourceName: "main0"), #imageLiteral(resourceName: "mainchar"),  #imageLiteral(resourceName: "main3"), #imageLiteral(resourceName: "main2"), #imageLiteral(resourceName: "main5")], distance: "5.5 miles", description: "A 2,000+ ft descent down a sustained gully which is prone to slide during/after storms. The gully itself is only about 30-35 degrees but the walls above it are 38-40 degrees and are a prime angle for sliding. This area is high elevation and has a decent protection from winds so the north side of the mountain can hold soft snow well after a storm in winter. There are various chutes if the main chute is tracked-out but they all take some navigating through some trees to get to. Follow the South Fork Trail for about 3.5 miles then cross the South Fork meadows and make your way up the low-angle, eastern side of Charlton as the route shows on the map. The entrance to the chute is within 400 feet from the summit and is visible next to a pile of rocks in the northerly direction.", marker: charMainMarker, aspect: "N", base: "6,900 ft", trailhead: southForkTH, summit: "10,800 ft", angle: "30-35")
