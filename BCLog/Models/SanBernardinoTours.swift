...
class SanBernardinoTours {
    ...
    static func loadTours(completion:@escaping (_ tours:[Tour])->()) {
        ...
        southForkTH.icon = GMSMarker.markerImage(with: .brown)
        ...
        let jepNWLine = GMSPolyline(path: sfPath)
        ...
        let charMain = Tour(title: "Charlton Peak: Main Gully", path: charMLine, id: "34.116171 -116.853881", imageURL: [#imageLiteral(resourceName: "main0"), #imageLiteral(resourceName: "mainchar"),  #imageLiteral(resourceName: "main3"), #imageLiteral(resourceName: "main2"), #imageLiteral(resourceName: "main5")], distance: "5.5 miles", description: "A 2,000+ ft descent down a sustained gully which is prone to slide during/after storms. The gully itself is only about 30-35 degrees but the sides of the gully are 38-40 degrees and are a prime angle for sliding. This area is generally protected from winds and high elevation so the north side of the mountain can hold soft snow well after a storm in winter. There are various chutes if the main chute is tracked-out but they all take some navigating through some trees to get to. Follow the South Fork Trail for about 3.5 miles then cross the South Fork meadows and make your way up the low-angle, eastern side of Charlton as the route shows on the map. The entrance to the chute is about 400 ft away and can be seen from the summit, next to a pile of rocks in the north direction.", marker: charMainMarker, aspect: "N", base: "6,900 ft", trailhead: southForkTH, summit: "10,800 ft", angle: "30-35")
