...
class SanJacintoTours {
    ...
    static func loadTours(completion:@escaping (_ tours:[Tour])->()) {
        ...
        let snowCreek = Tour(title: "San Jacinto: Snow Creek", difficulty: 3, path: snowCreekLine, id: "33.814693 -116.679236", imageURL: [#imageLiteral(resourceName: "snowcrk3"), #imageLiteral(resourceName: "snowcrk"), #imageLiteral(resourceName: "snowcrk2")], distance: 12, description: "The most extreme ascent/descent in Southern California and somewhat of a 'forbidden fruit', Snow Creek is essentially a giant funnel down the north face of San Jacinto. This couloir is as steep and sustained as it gets around here and avalanches frequently. With nearly 10k vert to reach the summit, arduous bushwhacking, and large waterfalls which may require ropes, Snow Creek doesn't get climbed that often, let alone skied. The crux of the route, the Chockstone, is only skiable during the best of seasons, such as when Andy Lewicky skied it in the El Nino year of 2010 (check out his report on SierraDescents.com). Otherwise, be prepared to climb. Even during good seasons, there will be no shortage of bushwhacking and rockclimbing as this route starts at nearly 1,000 feet on the desert floor. The standard approach goes through DWA land where trespassing is not allowed but this can be avoided by traversing around as the route on the map shows. Park at the utility station (33.898705, -116.679772) and head east towards the ridge on east side of Falls Creek. Climb this ridge until 4,300 feet and then traverse towards Snow Creek and enter the couloir at ~5,500 feet. Follow the couloir to the summit. Alternatively, some skiers have used two cars and approached via the Palm Springs Aerial Tramway and skied down the chute to the second car at the utility station. Another approach is using the tram for both entry and exit, but only skiing the chute a little ways and hiking back up to the summit.", marker: snowCreekMarker, aspect: "N", base: "1,200 ft", trailhead: snowCreekTH, summit: "10,850 ft", angle: "45")
