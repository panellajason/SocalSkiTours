...
class SanGabrielsTours {
    ...
    static func loadTours(completion:@escaping (_ tours:[Tour])->()) {
        ...
        let baldyBowl = Tour(title: "Mt Baldy: Baldy Bowl", path: baldyLine, id: "34.286354 -117.644966", imageURL: [#imageLiteral(resourceName: "IMG_1311"), #imageLiteral(resourceName: "IMG_1032"), #imageLiteral(resourceName: "baldy"), #imageLiteral(resourceName: "IMG_1041"), #imageLiteral(resourceName: "darechute"), #imageLiteral(resourceName: "img023"), #imageLiteral(resourceName: "bowl"), #imageLiteral(resourceName: "Baldy_Bowl_Chutes")], distance: "4.5 miles", description: "Without a doubt, the most popular and arguably the most dangerous mountain in Southern California. On a clear winter or early spring weekend, it is not uncommon to see 20-30+ hikers/skiers ascending the Bowl like a line of ants, 5 skiers descending various chutes simultaneously, all while a helicopter circles the ski hut making a rescue; it can be a circus out there sometimes. Despite all that, this is some of the best terrain in Socal, which explains why they've built two ski huts here since the 1930s (the original one burned down). On good snow years, at least 10+ chutes are rideable varying in length, aspect and angle. The looker's left of the bowl is more couloir/crag-like while the chutes in the center of the bowl are slightly wider and slightly less steep. Unforuntately, not every line fills in every year due to the inconsistent nature of Socal winters and the Bowl facing south to east; storms really need to pile up to make a sufficient base. Spring conditions (corn, melt/freeze cycles) plague the bowl all season, except after the coldest and driest of storms when powder may last or two days. The east facing side (looker's left) of the Bowl tends to be rideable the earliest, and latest, in the season. Each chute in the Bowl has its own feel and uniqueness and they will vary drastically from year to year depending on snow coverage. Follow the Baldy Bowl trail to the Ski Hut, then traverse to the looker's left of the Bowl and ascend the trees and follow the ridge to the chutes. Alternatively, climb the chute of choice but beware of constant rockfall and avalanches. Always start early and be out of the bowl early as this terrain heats up very quick and many are injured here every year.", marker: baldyBowlMarker, aspect: "S/E", base: "6,100 ft", trailhead: baldyTH, summit: "9,800 ft", angle: "30-45")
