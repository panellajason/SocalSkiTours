...
class SanGabrielsTours {
    ...
    static func loadTours(completion:@escaping (_ tours:[Tour])->()) {
        ...
        let baden = Tour(title: "Baden Powell: NE Gullies", difficulty: 2, path: badenLine, id: "34.361183 -117.762169", imageURL: [#imageLiteral(resourceName: "baden"), #imageLiteral(resourceName: "baden6"), #imageLiteral(resourceName: "baden4")], distance: 4, description: "Named after the founder of Boy Scouts, Baden Powell is a steep, complex mountain that is comprised of areas of well-spaced trees, steep gullies, and even some rocky chutes. The road is usually closed a few miles back from the trailhead in winter (so check Caltrans before driving up) but many will still walk/skin the road to ski the mountain. Once the road opens, Baden Powell is a popular spring skiing destination due to its easy access and sheltered, north facing gullies which hold snow well into a good season. There are many different gullies and chutes to choose from on this mountain, but be aware of waterfalls/drop-offs as some of the descents contain these features. Even the NE gullies have some steep, narrow sections at some point in the ski down. Be mindful of stability concerns as these gullies avalanche frequently during storm cycles. The normal approach from Vincent Gulch parking lot is quite steep and can be icy in the morning, sometimes requiring crampons, but the route slowly gives way to gentler slopes as you gain in elevation.", marker: badenMarker, aspect: "NE", base: "6,600 ft", trailhead: badenTH, summit: "9,400 ft", angle: "25-35")
        ...
        let baldyBowl = Tour(title: "Mt Baldy: Baldy Bowl", difficulty: 3, path: baldyLine, id: "34.286354 -117.644966", imageURL: [#imageLiteral(resourceName: "IMG_1311"), #imageLiteral(resourceName: "IMG_1032"), #imageLiteral(resourceName: "baldy"), #imageLiteral(resourceName: "IMG_1041"), #imageLiteral(resourceName: "darechute"), #imageLiteral(resourceName: "img023"), #imageLiteral(resourceName: "bowl"), #imageLiteral(resourceName: "Baldy_Bowl_Chutes")], distance: 4.5, description: "Without a doubt, the most popular mountain in Southern California. On a clear weekend with sufficient snow, you may see 20-30+ hikers/skiers ascending the Bowl like a line of ants, a few skiers descending various chutes, all while a helicopter circles the ski hut making a rescue; it can be a circus out there sometimes. Despite all this, this is some of the best alpine terrain in Southern California that hosts one of the only ski huts in the region (built in 1936). During good snow years, at least 10+ chutes are rideable varying in length, aspect and angle. The looker's left chutes are slightly steeper and more couloir-esque compared to the chutes in the center of the bowl. Due to the rocky nature of the bowl and its south-east aspect, storms really need to pile up to make a sufficient base before it melts right away. That being said, it can go from rocks to rideable with one big storm and some rock skis. Spring conditions (corn, melt/freeze cycles) plague the Bowl all season, except after the coldest and driest of storms when powder may last for one or two days. Follow the Baldy Bowl trail to the Ski Hut (which crosses numerous avalanche paths on the way up), then traverse to the looker's left of the Bowl and ascend the trees. Once atop this section, follow the ridge up to the chutes. Alternatively, climb the chute of choice but beware of constant rockfall and avalanches (climbers/skiers get caught in slides almost every year). An early start and an early finish is critical on these south facing slopes.", marker: baldyBowlMarker, aspect: "S/E", base: "6,100 ft", trailhead: baldyTH, summit: "9,800 ft", angle: "30-45")
        ...
        let waterman = Tour(title: "Mt Waterman: Ski Area", difficulty: 1, path: watermanLine, id: "34.345932 -117.933253", imageURL: [#imageLiteral(resourceName: "waterman"), #imageLiteral(resourceName: "waterman2")], distance: 1, description: "Although still operating, Mount Waterman Ski Lifts is open at such an inconsistent rate (usually weekends, if at all, especially after the Bobcat fire) it may as well be considered a backcountry destination. Boasting the first chairlift in Southern California and the second in the state, Waterman opened in 1939 and is a gem in Southern California's ski history. The website is still active and lift-accessed skiing does happen here, so don't be suprised if the resort is open when you arrive; just drive down the road and ski something else (Krakta Ridge, Buckhorn, Throop, Islip). The joys of Waterman are its steep ski runs, tight gullies and parking as close as it gets to the goods. There are plently of other options just off of the resort area as well. Some of which that are much more exciting and exposed than the normal Waterman day, such as the Avalanche Chutes off of the summit which drop you a few miles down the road from the parking area. Highway 2 can be quite fickle with opening after a storm so keep an eye on Caltrans before making the drive. The western San Gabriels are lower elevation and very close to the ocean so San Gabriel Cement/Stucco (similar to Sierra Cement but worse) is common.", marker: watermanMarker, aspect: "N", base: "6,800 ft", trailhead: watermanTH, summit: "7,800 ft", angle: "25-30")
