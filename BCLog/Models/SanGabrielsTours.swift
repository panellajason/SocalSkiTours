...
class SanGabrielsTours {
    ...
    static func loadTours(completion:@escaping (_ tours:[Tour])->()) {
        ...
        let baldyBowl = Tour(title: "Mt Baldy: Baldy Bowl", difficulty: 3, path: baldyLine, id: "34.286354 -117.644966", imageURL: [#imageLiteral(resourceName: "IMG_1311"), #imageLiteral(resourceName: "IMG_1032"), #imageLiteral(resourceName: "baldy"), #imageLiteral(resourceName: "IMG_1041"), #imageLiteral(resourceName: "darechute"), #imageLiteral(resourceName: "img023"), #imageLiteral(resourceName: "bowl"), #imageLiteral(resourceName: "Baldy_Bowl_Chutes")], distance: 4.5, description: "Without a doubt, the most popular mountain in Southern California. On a clear weekend with sufficient snow, you may see 20-30+ hikers/skiers ascending the Bowl like a line of ants, 5 skiers descending various chutes, all while a helicopter circles the ski hut making a rescue; it can be a circus out there sometimes. Despite all this, this is some of the best alpine terrain in Southern California that hosts one of the only ski huts in the region (built in 1936). During good snow years, at least 10+ chutes are rideable varying in length, aspect and angle. The looker's left of the bowl is more couloir/crag-like while the chutes in the center of the bowl are slightly wider and less exposed. Due to the rocky nature of the bowl and its southeast aspect, storms really need to pile up to make a sufficient base. That being said, it can go from rocks to rideable with one big storm and some rock skis. Spring conditions (corn, melt/freeze cycles) plague the Bowl all season, except after the coldest and driest of storms when powder may last for one or two days. Follow the Baldy Bowl trail to the Ski Hut (which crosses numerous avalanche paths on the way up), then traverse to the looker's left of the Bowl and ascend the trees. Once atop this section, follow the ridge up to the chutes. Alternatively, climb the chute of choice but beware of constant rockfall and avalanches (climbers/skiers get caught in slides almost every year, even during the lowest of snow years). Always start early and be out of the bowl early as this terrain heats up quickly and many are injured here every year.", marker: baldyBowlMarker, aspect: "S/E", base: "6,100 ft", trailhead: baldyTH, summit: "9,800 ft", angle: "30-45")
